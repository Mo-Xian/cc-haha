...
第 9 行 全 8 格：接着上一行，从正下方继续向左转，经过左下、左边、左上，转回接近正上方`,
  ...
  'settings.providers.imageReadEnabled': '启用识图',
  'settings.providers.imageReadEnabledDesc': '允许聊天用独立的 vision 模型识别图片（主模型无需 vision 能力）。凭证保存在服务商设置中。',
  'settings.providers.imageReadModel': '识图模型',
  'settings.providers.imageReadModelPlaceholder': 'qwen3-vl-30b-a3b-thinking',
  'settings.providers.imageReadModelHint': '必填，请填写该上游暴露的识图(视觉)模型 ID。',
  'settings.providers.imageReadBaseUrl': '识图 API 地址',
  'settings.providers.imageReadBaseUrlPlaceholder': 'https://api.example.com/v1',
  'settings.providers.imageReadBaseUrlHint': '可选，留空则复用聊天服务商的接口地址。',
  'settings.providers.imageReadApiKey': '识图 API Key',
  'settings.providers.imageReadApiKeyHint': '可选，留空则复用聊天服务商的 API Key。',
