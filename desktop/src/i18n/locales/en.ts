...
Row 9, all 8 cells: continuing from straight down, turning left through lower-left, left and upper-left, back to near straight up`,
  ...
  'settings.providers.imageReadEnabled': 'Enable image recognition',
  'settings.providers.imageReadEnabledDesc': 'Let chat recognize images with a dedicated vision model (the main model needs no vision capability). Credentials stay in provider settings.',
  'settings.providers.imageReadModel': 'Vision model',
  'settings.providers.imageReadModelPlaceholder': 'qwen3-vl-30b-a3b-thinking',
  'settings.providers.imageReadModelHint': 'Required. Use the vision model ID exposed by this upstream.',
  'settings.providers.imageReadBaseUrl': 'Vision API Base URL',
  'settings.providers.imageReadBaseUrlPlaceholder': 'https://api.example.com/v1',
  'settings.providers.imageReadBaseUrlHint': 'Optional. Leave blank to reuse the chat provider Base URL.',
  'settings.providers.imageReadApiKey': 'Vision API Key',
  'settings.providers.imageReadApiKeyHint': 'Optional. Leave blank to reuse the chat provider API key.',
