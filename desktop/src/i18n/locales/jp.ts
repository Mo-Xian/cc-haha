...
9 行目 8 マスすべて：前の行に続き、真下から左へ回り、左下・左・左上を通って真上の手前まで`,
  ...
  'settings.providers.imageReadEnabled': '画像認識を有効にする',
  'settings.providers.imageReadEnabledDesc': '専用の vision モデルで画像を認識できるようにします（メインモデルに vision は不要）。認証情報はプロバイダー設定に保存されます。',
  'settings.providers.imageReadModel': '識別モデル',
  'settings.providers.imageReadModelPlaceholder': 'qwen3-vl-30b-a3b-thinking',
  'settings.providers.imageReadModelHint': '必須。この上流が公開する識別(ビジョン)モデル ID を入力してください。',
  'settings.providers.imageReadBaseUrl': '識別 API ベース URL',
  'settings.providers.imageReadBaseUrlPlaceholder': 'https://api.example.com/v1',
  'settings.providers.imageReadBaseUrlHint': '任意。空欄の場合はチャットプロバイダーのベース URL を再利用します。',
  'settings.providers.imageReadApiKey': '識別 API キー',
  'settings.providers.imageReadApiKeyHint': '任意。空欄の場合はチャットプロバイダーの API キーを再利用します。',
