...
9번째 줄 8칸 전부: 앞 줄에 이어 정면 아래에서 왼쪽으로 돌아 왼쪽 아래, 왼쪽, 왼쪽 위를 지나 정면 위 직전까지`,
  ...
  'settings.providers.imageReadEnabled': '이미지 인식 사용',
  'settings.providers.imageReadEnabledDesc': '전용 vision 모델로 이미지를 인식할 수 있게 합니다(메인 모델에 vision 불필요). 인증 정보는 공급자 설정에 저장됩니다.',
  'settings.providers.imageReadModel': '비전 모델',
  'settings.providers.imageReadModelPlaceholder': 'qwen3-vl-30b-a3b-thinking',
  'settings.providers.imageReadModelHint': '필수입니다. 이 업스트림이 제공하는 비전 모델 ID를 입력하세요.',
  'settings.providers.imageReadBaseUrl': '비전 API 기본 URL',
  'settings.providers.imageReadBaseUrlPlaceholder': 'https://api.example.com/v1',
  'settings.providers.imageReadBaseUrlHint': '선택 사항입니다. 비워 두면 채팅 공급자의 기본 URL을 재사용합니다.',
  'settings.providers.imageReadApiKey': '비전 API 키',
  'settings.providers.imageReadApiKeyHint': '선택 사항입니다. 비워 두면 채팅 공급자의 API 키를 재사용합니다.',
