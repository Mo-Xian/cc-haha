...
第 9 列 全 8 格：接著上一列，從正下方繼續向左轉，經過左下、左邊、左上，轉回接近正上方`,
  ...
  'settings.providers.imageReadEnabled': '啟用識圖',
  'settings.providers.imageReadEnabledDesc': '允許聊天用獨立的 vision 模型識別圖片（主模型無需 vision 能力）。憑證保存在服務商設定中。',
  'settings.providers.imageReadModel': '識圖模型',
  'settings.providers.imageReadModelPlaceholder': 'qwen3-vl-30b-a3b-thinking',
  'settings.providers.imageReadModelHint': '必填，請填寫此上游提供的識圖(視覺)模型 ID。',
  'settings.providers.imageReadBaseUrl': '識圖 API 位址',
  'settings.providers.imageReadBaseUrlPlaceholder': 'https://api.example.com/v1',
  'settings.providers.imageReadBaseUrlHint': '選填，留空則沿用聊天服務商的介面位址。',
  'settings.providers.imageReadApiKey': '識圖 API Key',
  'settings.providers.imageReadApiKeyHint': '選填，留空則沿用聊天服務商的 API Key。',
